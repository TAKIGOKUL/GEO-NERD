...
const ImagePanel = ({ location, guessCount, onNextLocation, onRevealLocation, hasGuessed, showActualLocation, gameStats, roundResults, currentRound, maxRounds, countdown }) => {
    ...
    <div className="image-panel">
            ...
            <div className="timer-circle">
              <svg viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  strokeDashoffset={`${2 * Math.PI * 45 * (1 - (countdown || 5) / 5)}`}
                  style={{
      ...
      <div className="location-info">
        ...
        <div className="guess-controls">
          ...
          {countdown > 0 && showActualLocation && (
